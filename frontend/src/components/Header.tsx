      ...
      <div className="main-menu">
        <h1>
          <Link href="/" className="button logo link-button">
            ...
            <span className="text-xl desktop-long-label">THE GOOD CORNER</span>
          </Link>
        </h1>
        <form
        ...
        >
          <input
            className="text-gray-700 text-field main-search-field"
            type="search"
            value={search}
        ...
        <Link href="/new" className="button link-button">
